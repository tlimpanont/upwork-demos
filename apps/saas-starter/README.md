...
- **Auth.js v5** (NextAuth) — credentials provider + JWT sessions, edge-compatible middleware
...
- Settings — display name, password change, workspace rename, danger-zone workspace deletion (cancels Stripe sub, cascades all org data)
...
proxy.ts                      Next.js 16 middleware — protects /dashboard/*
